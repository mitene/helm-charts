...
helm.sh/chart: {{ include "cloudwatch-agent.chart" . }}
...
{{- if .Values.serviceAccount.create -}}
    {{ default (include "cloudwatch-agent.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
    {{ default "cloudwatch-agent" .Values.serviceAccount.name }}
{{- end -}}
{{- end -}}
